...
NeoForge 1.21.11 port of SoulSort. Same behaviour as the Fabric and Forge builds:
...
Targets NeoForge 21.11.42 for Minecraft 1.21.11. Output jar lands in `build/libs/`.
